...
public class RunApplicationAndWriteData {
    ...
    @Bean
    CommandLineRunner writeData(NationRepository nationRepository, JobRepository jobRepository, RegionRepository regionRepository, OriginalCharacterRepository originalCharacterRepository)
    {
        return args -> {
